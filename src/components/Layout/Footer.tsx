...
const partnerDashboardUrl = import.meta.env.VITE_PARTNER_DASHBOARD_URL || 'http://localhost:5174/login';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>
                <a href={partnerDashboardUrl} className="hover:text-white transition-colors">
                  Partner With Us
                </a>
              </li>
              <li>
